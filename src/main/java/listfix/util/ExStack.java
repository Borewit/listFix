...
public class ExStack {
   ...
   * chained to the exception. Note the use of the Java 1.4 StackTraceElement to get stack details.
   * The returned string begins with "<html>" and is therefore suitable for display in Swing
